...
import ke.co.amini.config.audit.AuditEventConverter;
import ke.co.amini.domain.PersistentAuditEvent;
...
import static ke.co.amini.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
