...
import ke.co.amini.config.Constants;
import ke.co.amini.AminiApp;
import ke.co.amini.domain.Authority;
import ke.co.amini.domain.User;
import ke.co.amini.repository.AuthorityRepository;
import ke.co.amini.repository.UserRepository;
import ke.co.amini.security.AuthoritiesConstants;
import ke.co.amini.service.MailService;
import ke.co.amini.service.dto.UserDTO;
import ke.co.amini.web.rest.errors.ExceptionTranslator;
import ke.co.amini.web.rest.vm.KeyAndPasswordVM;
import ke.co.amini.web.rest.vm.ManagedUserVM;
import ke.co.amini.service.UserService;
